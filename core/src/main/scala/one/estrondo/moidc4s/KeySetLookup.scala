...
private[moidc4s] object KeySetLookup {

  private[moidc4s] class External[F[_]](source: Source[F, KeySet]) extends Lookup[F, KeySet] {
  ...
  private[moidc4s] class FromJwkSet[F[_]](source: Source[F, JwkSet]) extends Lookup[F, KeySet] {
